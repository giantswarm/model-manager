"""ATS smoke for the model-manager chart.
...
Deployment is ready with the image the branch build pushed. No serving backend
exists on the cluster; readiness does not depend on one.
"""
